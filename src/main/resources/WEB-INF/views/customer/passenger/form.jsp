...
<acme:form>
	<acme:input-textbox code="customer.passenger.form.label.fullName" path="fullName" placeholder="customer.passenger.form.placeholder.fullName"/>
	<acme:input-email code="customer.passenger.form.label.email" path="email"/>
	<acme:input-textbox code="customer.passenger.form.label.passportNumber" path="passportNumber" placeholder="A9HJ3GRU0"/>
	...
	<jstl:choose>
		...
		<jstl:when test="${acme:anyOf(_command, 'create|publish') && !createdInBooking}">
