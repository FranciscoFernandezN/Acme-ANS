...
public class ManagerLegStatusService extends AbstractGuiService<Manager, Leg> {
	...
	public void authorise() {
		...
		status = super.getRequest().getPrincipal().hasRealmOfType(Manager.class) && super.getRequest().getPrincipal().getRealmOfType(Manager.class).getId() == leg.getManager().getId() && leg.getIsDraftMode() && !leg.getIsDraftMode();
